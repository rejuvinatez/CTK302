...
function setup() {
  ...
  f1 = loadFont("assets/FoulFiend.ttf");
  f2 = loadFont("assets/rock.ttf");
  f3 = loadFont("assets/spaceage.ttf");
  bg = loadImage("assets/zombiepaintball.jpg");
...
function draw() {
  switch (state) {
    case 0:
      background('red');
      text("Welcome to Zombie Apocalypse!", width / 2, height / 2);
      break;
    ...
    case 3:
      ...
      fill('yellow');
      textSize(20);
      text("You did not survive",  width / 2, height / 2);
      break;
...
function checkForKeys() {
  ...
  if (keyIsDown(UP_ARROW)) frogPos.X -= 5;
...
class Car {
  ...
  display() {
    ...
    //textFont(this.font);
    //textSize(this.size);
    //text("fall2020", this.pos.x, this.pos.y);
